...
function storeInfo() {
  ...
  // Luego de almacenar los datos en los cookies debe redireccionar a la misma 
  // pagina (refreshing) para que recien se puedan mostrar los datos almacenados
  // Por que???, porque al enviar un mensaje http para almacenar una cookie
  // el uso del cookie por parte del navegador no se efectuara automaticamente
  // se efectuara la proxima vez que redireccione, entonces aca solicitamos hacer un refreshing
  // para que los datos almacenados en los cookies puedan ser mostrados en los controles
  // solo cuando se haga un refresh
...
<?php } else { ?>
    <!-- Este formulario envia un mensaje post con los parametros de los campos
         que llena el usuario, remember_me al recibir la solitud post almacena
         dichos valores de los parametros en cookies -->
