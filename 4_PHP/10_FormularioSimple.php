...
<html>
    ...
    <body>
        <?php
            ...
            // Si submitButton esta presente en el metodo post significa que 
            // la pagina que se muestra es resultado de una solicitud POST
            // que surge al hacer click en el boton submit button
            ...
            {
                // de lo contrario muestra el formulario con los campos para
                // ser llenados, le pasa un array vacio
                displayForm( array() );
            }
            
            // Recibe un nombre de campo y el listado de los campos que estan
            // sin rellenar, devuelve el nombre de la clase css usada para 
            // el mensaje de validacion
        ...
        <form action="registration.php" method="post">
            <div style="width: 30em;">
                ...
                <label for="genderMale"2>Male</label>
