...
function listarTablaMultiplicar(pedido,respuesta) {
	/*
	Utilizamos el objeto url llamando al método parse y 
	pasando dos parámetros: pedido.url y el valor true. 
	Mediante el objeto que nos devuelve accedemos a la propiedad 
	query y en este objeto tenemos una propiedad llamada igual a 
	nuestro parámetro 'numero'. 
